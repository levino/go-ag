// Partieprotokoll 13×13 – Go/Baduk/Weiqi
...
#let lw          = 0.2mm
#let board       = 13
#let col-labels  = ("A","B","C","D","E","F","G","H","J","K","L","M","N")
...
#grid(
  ...
  // 1: Metadaten
  titlebox(
    [#text(size: 13pt, weight: "bold")[Partieprotokoll — 13×13]],
    grid(
      columns: (1fr, 1fr, 1fr),
      inset: .4em,
  ...
  layout(size => {
    let sp-h = size.height / 14.2
    let sp-w = size.width  / 14.0
